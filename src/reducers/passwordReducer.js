...
export const passwordReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case EDIT_CONTACT:
            let aray = state.passwords.filter((password) => password.id == action.payload);
            aray = aray.values();
            for (let val of aray) {
                aray = val;
            }
        ...
        case DELETE_SELECTED_PASSWORDS:
            return {
                ...state,
                passwords: [],
            }
